...
<experiments>
  ...
  <experiment name="SINGLE-Resource-weekend-vary-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
  ...
  <experiment name="SINGLE-Varying-seeds-PA-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="120"/>
    <metric>utilization</metric>
  ...
  <experiment name="PA-SVRS-seed-selection-algo" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="60"/>
    <metric>utilization</metric>
    ...
    <enumeratedValueSet variable="seed-selection-algorithm">
      <value value="&quot;one-step-spread-hill-climbing-with-random-tie-breaking&quot;"/>
      <value value="&quot;randomly-with-knapsack-assignment&quot;"/>
      <value value="&quot;naive-degree-ranked-with-knapsack-assignment&quot;"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="MULTIPLE-Threshold-vary-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>max-utilization</metric>
  ...
  <experiment name="MULTIPLE-Cost-vary-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
  ...
  <experiment name="MULTIPLE-Resource-vary-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
  ...
  <experiment name="MULTIPLE-Global-Influence-vary-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
  ...
  <experiment name="MULTIPLE-Threshold-Cost-vary-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
  ...
  <experiment name="MULIPLE-Threshold-Resource-vary-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
  ...
  <experiment name="MULTIPLE-Cost-Resource-vary-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
  ...
  <experiment name="MULTIPLE- Threshold-Cost-Resource-vary-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
  ...
  <experiment name="MULTIPLE- Threshold-Cost-Resource-Global-vary-SVRS-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
  ...
  <experiment name="MULTIPLE-PA-SVRS-Global-Influence-vary-threshold-avg" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>max-utilization</metric>
