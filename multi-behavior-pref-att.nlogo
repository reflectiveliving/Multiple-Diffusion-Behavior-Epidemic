...
<experiments>
  ...
  <experiment name="trial-experiment" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>utilization</metric>
    ...
    <steppedValueSet variable="rand-seed-threshold" first="4937" step="1" last="5036"/>
    ...
    <enumeratedValueSet variable="behavior-durations">
      <value value="&quot;[1 3 1]&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="rand-seed-network">
      <value value="2164"/>
