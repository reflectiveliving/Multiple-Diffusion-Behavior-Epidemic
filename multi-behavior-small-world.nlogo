...
<experiments>
  ...
  <experiment name="SI-SIR-SIvRS-SW-threshold-average-cost-varying" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>utilization</metric>
  ...
  <experiment name="SIRS-SW-threshold-average-cost-varying" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>utilization</metric>
  ...
  <experiment name="SIR-SIvS-SIRS-complete-max-utlization-cost-varying" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>utilization</metric>
  ...
  <experiment name="SIvRS-Complete-graph-threshold-avg-cost-varying" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>utilization</metric>
  ...
  <experiment name="SIRS-SW-duration-varying" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <metric>utilization</metric>
  ...
  <experiment name="SVRS-Threshold-avg-carying-cost" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
  ...
  <experiment name="SVRS-threshold-avg-varying-global-influence" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>utilization</metric>
    ...
    <steppedValueSet variable="positive-effect-probability" first="0.3" step="1" last="0.9"/>
    <enumeratedValueSet variable="rewiring-probability">
      <value value="0.2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="behavior-recovered-duration">
